...
@php
    ...
    $totalSuccess = $dailySummary->sum('total_success');
    $totalFailed = $dailySummary->sum('total_failed');
@endphp
<div class="row">
                    ...
                    <div class="col">
                        <div class="card radius-10 bg-info mb-0">
                            <div class="card-body text-center">
                                ...
                                <h3 class="text-white">{{ $connected_marketplaces }}</h3>
                                <p class="mb-0 text-white">Connected Marketplaces</p>
                            </div>
                        </div>
                    </div>
                     <div class="col">
                     ...
                     <div class="col">
                        <div class="card radius-10 bg-success mb-0">
                            <div class="card-body text-center">
                                ...
                                <h3 class="text-white">{{ $shipped_orders }}</h3>
                                <p class="mb-0 text-white">Shipped Orders</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card radius-10 bg-orange mb-0">
                            <div class="card-body text-center">
                                ...
                                <h3 class="text-white">${{ number_format($balance, 2) }}</h3>
                                <p class="mb-0 text-white">ShipStation Wallet Balance</p>
                            </div>
                        </div>
                    </div>
                 <div class="col">
                    <div class="card radius-10 bg-purple mb-0">
                        <div class="card-body text-center">
                            ...
                            <p class="mb-0 text-white">Total Awaiting for Print</p>
                        </div>
                    </div>
                </div>
                 <div class="col">
                    <div class="card radius-10 bg-dark mb-0">
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-white">{{ $total_labels_created }}</h3>
                            <p class="mb-0 text-white">Total Labels Created</p>
                        </div>
                    </div>
                </div>
                </div>
    ...
    <div class="col-12 col-lg-12 col-xl-6 d-flex d-none">
        <div class="card radius-10 w-100">
    ...
    <div class="col-6 col-md-6">
        <div class="card radius-10 w-100">
            <div class="card-header bg-transparent">
                <div class="row g-3 align-items-center">
                    <div class="col">
                        <h5 class="mb-0">Bulk Shipping Summary</h5> 
                    </div>
                </div>
            </div>
            <div class="card-body">
...
$(function() {
    ...
    // Bulk Shipping Summary (3D Pie Chart - unchanged)
// Bulk Shipping Summary (3D Interactive Pie Chart)
Highcharts.chart('Chart', {
    ...
    title: {
        text: 'Bulk Shipping Success vs Failed ({{ $today }})'
    },
    accessibility: {
        point: {
            valueSuffix: '%'
    ...
    // Dashboard Summary (3D Interactive Column Chart)
   // Dashboard Summary (3D Interactive Column Chart)
    Highcharts.chart('barChart', {
        ...
        subtitle: {
            text: 'Interactive 3D Column Chart'
        },
        accessibility: {
            point: {
                valueSuffix: ' Count'
        ...
        xAxis: {
            categories: ['Connected Marketplaces', 'Pending Orders', 'Shipped Orders', 'Total Staff', 'Awaiting for Print', 'Labels Created'],
            crosshair: true
        },
        yAxis: {
            title: {
        ...
        series: [{
            ...
            data: [
                ...
                {{ $pending_orders }},
                {{ $shipped_orders }},
                {{ isset($total_staff) ? $total_staff : 0 }},  // Fallback if not defined
                {{ $all_courier }},
