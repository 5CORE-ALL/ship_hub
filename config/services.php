...
return [
    ...
    */
    ...
    'google' => [
        'client_id'     => env('GOOGLE_CLIENT_ID', '[REMOVED_CLIENT_ID]'),
        'client_secret' => env('GOOGLE_CLIENT_SECRET', '[REMOVED_SECRET]'),
        'redirect'      => env('GOOGLE_REDIRECT', 'https://fdcd301b5647.ngrok-free.app/auth/google/callback'),
    ],
    'macy' => [
